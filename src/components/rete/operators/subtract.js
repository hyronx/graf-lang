...
export class SubtractComponent extends Rete.Component {
  ...
  builder(node) {
    const first = new Rete.Input("first", "Minuend", numberSocket)
    const second = new Rete.Input("second", "Subtrahend", numberSocket)
    const out = new Rete.Output("result", "Difference", numberSocket)
