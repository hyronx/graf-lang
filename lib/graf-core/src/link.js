...
export class Link {
  ...
  constructor(source, target, type, sourceNode = null, targetNode = null) {
    ...
    this.target = target
    this.type = type
    this.sourceNode = sourceNode || source.constructor.name.includes("Node") ? source : null
    this.targetNode = targetNode || target.constructor.name.includes("Node") ? target : null
  }
