...
import { Metatype, ArgumentInfo, ResultInfo, TestSetInfo } from "./meta"

export class Argument implements Metatype, ArgumentInfo {
  typeName = "Argument"
...
export class Result extends Argument implements Metatype, ResultInfo {
  typeName = "Result"
...
export class TestSet implements Metatype, TestSetInfo {
  typeName = "TestSet"
...
export default class Operation implements Metatype {
  typeName = "Operation"
  doValidate = false
  isAsync: boolean
  isGenerator: boolean
